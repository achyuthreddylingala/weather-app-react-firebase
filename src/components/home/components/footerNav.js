...
const FooterNav = props => {
  ...
  return /*#__PURE__*/_jsx(React.Fragment, {
    children: /*#__PURE__*/_jsxs("section", {
      ...
      className: "footer-nav d-flex flex-row align-items-center justify-content-around ",
      children: [/*#__PURE__*/_jsxs("section", {
        role: "button",
        ...
        children: [/*#__PURE__*/_jsx("section", {
          ...
          className: "footer-icons footer-app-svg-section d-flex align-items-center justify-content-center my-2",
